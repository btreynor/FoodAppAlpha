...
import exception.OrderAlreadyDeliverException;
import exception.OrderAlreadyFinishedException;
import exception.OrderNotExistException;
import exception.OrderNotFinishedException;
import exception.PasswordNoMatchException;
...
public class DriverController {
    ...
    public Driver loginDriver(@RequestBody String jsonUser)
            throws UserNotExistException, PasswordNoMatchException {
        ...
        if (!driverService.passwordMatch(String.valueOf(driver.get().getId()), password)) {
            throw new PasswordNoMatchException("Password doesn't match");
        }
        return driver.get();
    }
    ...
    public int finishOrder(@RequestBody String jsonOrder)
            throws OrderNotExistException, OrderAlreadyFinishedException {
        JSONObject order = new JSONObject(jsonOrder);
    ...
    @ExceptionHandler({ UserNotExistException.class, PasswordNoMatchException.class,
            UserAlreadyExistsException.class, OrderNotExistException.class,
            OrderAlreadyDeliverException.class, OrderAlreadyFinishedException.class,
