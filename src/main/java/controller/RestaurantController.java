...
import exception.DishNotExistException;
...
import service.SearchEngineServiceImpl;
...
public class RestaurantController {
    ...
    public Restaurant loginRestaurant(@RequestBody String jsonUser)
        ...
        if (!restaurantService.passwordMatch(String.valueOf(restaurant.get().getId()), password)) {
    ...
    @ExceptionHandler({ UserNotExistException.class, PasswordNoMatchException.class,
            UserAlreadyExistsException.class, DishNotExistException.class,
